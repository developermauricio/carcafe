(function ($) {
    ...
    MapSVG.Map.prototype = {
        ...
        setLayersControl: function (options) {
            var _this = this;
            if (options) $.extend(true, _this.options.layersControl, options);
            if (_this.options.layersControl.on) {
                if (!_this.$layersControl) {
                    _this.$layersControl = $('<div class="mapsvg-layers-control"></div>');
                    _this.$layersControlLabel = $(
                        '<div class="mapsvg-layers-label"></div>'
                    ).appendTo(_this.$layersControl);
                    _this.$layersControlListWrap = $(
                        '<div class="mapsvg-layers-list-wrap"></div>'
                    ).appendTo(_this.$layersControl);
                    _this.$layersControlListNano = $('<div class="nano"></div>').appendTo(
                        _this.$layersControlListWrap
                    );
                    _this.$layersControlList = $(
                        '<div class="mapsvg-layers-list nano-content"></div>'
                    ).appendTo(_this.$layersControlListNano);
                ...
                _this.$layersControl.removeClass(
                ...
                if (
                    _this.options.menu.on &&
                    !_this.options.menu.customContainer &&
                    _this.options.layersControl.position.indexOf("left") !== -1
                ) {
                ...
                _this.options.groups.forEach(function (g) {
                    var item = $(
                        '<div class="mapsvg-layers-item" data-group-id="' +
                            ...
                            "</label> " +
                            "</div>"
                    ).appendTo(_this.$layersControlList);
                });
                _this.$layersControlListNano.nanoScroller({
        ...
        setFloorsControl: function (options) {
            var _this = this;
            if (options) $.extend(true, _this.options.floorsControl, options);
            if (_this.options.floorsControl.on) {
                if (!_this.$floorsControl) {
                    _this.$floorsControl = $('<div class="mapsvg-floors-control"></div>');
                    _this.$floorsControlLabel = $(
                        '<div class="mapsvg-floors-label"></div>'
                    ).appendTo(_this.$floorsControl);
                    _this.$floorsControlListWrap = $(
                        '<div class="mapsvg-floors-list-wrap"></div>'
                    ).appendTo(_this.$floorsControl);
                    _this.$floorsControlListNano = $('<div class="nano"></div>').appendTo(
                        _this.$floorsControlListWrap
                    );
                    _this.$floorsControlList = $(
                        '<div class="mapsvg-floors-list nano-content"></div>'
                    ).appendTo(_this.$floorsControlListNano);
                ...
                _this.$floorsControl.removeClass(
                    "mapsvg-top-left mapsvg-top-right mapsvg-bottom-left mapsvg-bottom-right"
                );
                ...
                _this.options.floors.forEach(function (f) {
                    var item = $(
                        '<div class="mapsvg-floors-item" data-floor-id="' +
                            ...
                            "</label> " +
                            "</div>"
                    ).appendTo(_this.$floorsControlList);
                });
                _this.$floorsControlListNano.nanoScroller({
                    preventPageScrolling: true,
                    iOSNativeScrolling: true,
                });
        ...
        getPagination: function (callback) {
            ...
            pager
                .on("click", ".mapsvg-next:not(.disabled)", function (e) {
                    ...
                    _this.database
                        .getAll({ page: _this.database.query.page + 1 })
                        .done(function () {
                            callback && callback();
                        });
                })
                ...
                if (dbObjects && dbObjects.length > 0) {
                    dbObjects.forEach(function (object) {
                        if (
                            ...
                            !(object[locationField] instanceof Location) &&
                            ((object[locationField].lat && object[locationField].lng) ||
                                (object[locationField].x && object[locationField].y))
                        ) {
                            object[locationField].img = _this.getMarkerImage(
                                object,
                                object[locationField]
                            );
        ...
        clusterizeMarkers: function (skipFitMarkers) {
            ...
            _this.clustersByZoom &&
                _this.clustersByZoom[_this.zoomLevel] &&
                _this.clustersByZoom[_this.zoomLevel].forEach(function (cluster) {
                    // Don't clusterize on google maps with zoom level >= 17
                    if (
                        _this.options.googleMaps.on &&
                        _this.googleMaps.map &&
                        _this.googleMaps.map.getZoom() >= 17
                    ) {
        ...
        on: function (event, callback) {
            ...
            if (!_this.events[event]) _this.events[event] = [];
        ...
        setEvents: function (functions) {
            ...
            for (var eventName in functions) {
                if (typeof functions[eventName] === "string") {
                    ...
                    else _this.events[eventName] = null;
        ...
        setDetailsView: function (options) {
            ...
            if (
                _this.options.detailsView.location === "top" &&
                _this.options.menu.position === "left"
            ) {
                _this.options.detailsView.location = "leftSidebar";
            } else if (
                _this.options.detailsView.location === "top" &&
                _this.options.menu.position === "right"
            ) {
            ...
            _this.$details.toggleClass(
                "mapsvg-details-container-relative",
                !(MapSVG.isPhone && _this.options.detailsView.mobileFullscreen) &&
                    !_this.shouldBeScrollable(_this.options.detailsView.location)
            );
                ...
                if (name != undefined) {
                    ...
                    if (name == "directoryItem" || name == "directoryCategoryItem") {
                        ...
                        t =
                            ...
                            "</div>{{/each}}";
                        if (
                            _this.options.menu.categories &&
                            _this.options.menu.categories.on &&
                            _this.options.menu.categories.groupBy
                        ) {
        ...
        update: function (options) {
            ...
            for (var key in options) {
                if (key == "regions") {
                    ...
                    if (typeof _this[setter] == "function") this[setter](options[key]);
                    else {
        ...
        setRegionStatuses: function (_statuses) {
            ...
            for (var status in _this.options.regionStatuses) {
                colors[status] = _this.options.regionStatuses[status].color.length
                    ? _this.options.regionStatuses[status].color
                    : undefined;
            }
        ...
        setColors: function (colors) {
            ...
            if (colors && colors.status) _this.options.colors.status = colors.status;

            if (_this.options.colors.markers) {
                for (var z in _this.options.colors.markers) {
                    for (var x in _this.options.colors.markers[z]) {
                        _this.options.colors.markers[z][x] = parseInt(
                            _this.options.colors.markers[z][x]
                        );
                    }
                }
            }
            ...
            if (_this.options.colors.hover)
                _this.options.colors.hover =
                    _this.options.colors.hover == "" + parseInt(_this.options.colors.hover)
                        ? parseInt(_this.options.colors.hover)
                        : _this.options.colors.hover;
            if (_this.options.colors.selected)
                _this.options.colors.selected =
                    _this.options.colors.selected == "" + parseInt(_this.options.colors.selected)
                        ? parseInt(_this.options.colors.selected)
                        : _this.options.colors.selected;
            ...
            var markerCssText =
                ...
                "  opacity: " +
                _this.options.colors.markers.inactive.opacity / 100 +
                ";\n" +
                "  -webkit-filter: grayscale(" +
                (100 - _this.options.colors.markers.inactive.saturation) +
                "%);\n" +
                "  filter: grayscale(" +
                (100 - _this.options.colors.markers.inactive.saturation) +
                "%);\n" +
                ...
                "  opacity: " +
                _this.options.colors.markers.active.opacity / 100 +
                ";\n" +
                "  -webkit-filter: grayscale(" +
                (100 - _this.options.colors.markers.active.saturation) +
                "%);\n" +
                "  filter: grayscale(" +
                (100 - _this.options.colors.markers.active.saturation) +
                "%);\n" +
                ...
                "  opacity: " +
                _this.options.colors.markers.unhovered.opacity / 100 +
                ";\n" +
                "  -webkit-filter: grayscale(" +
                (100 - _this.options.colors.markers.unhovered.saturation) +
                "%);\n" +
                "  filter: grayscale(" +
                (100 - _this.options.colors.markers.unhovered.saturation) +
                "%);\n" +
                ...
                "  opacity: " +
                _this.options.colors.markers.hovered.opacity / 100 +
                ";\n" +
                "  -webkit-filter: grayscale(" +
                (100 - _this.options.colors.markers.hovered.saturation) +
                "%);\n" +
                "  filter: grayscale(" +
                (100 - _this.options.colors.markers.hovered.saturation) +
                "%);\n" +
            ...
            $.each(_this.options.colors, function (key, color) {
                if (color === null || color == "") delete _this.options.colors[key];
            });
        ...
        setTooltips: function (options) {
            ...
            if (_this.tooltip.container) {
                _this.tooltip.container[0].className = _this.tooltip.container[0].className.replace(
                    /(^|\s)mapsvg-tt-\S+/g,
                    ""
                );
            } else {
            ...
            _this.tooltip.container.css({
                "min-width": _this.options.tooltips.minWidth + "px",
                "max-width": _this.options.tooltips.maxWidth + "px",
            });
            ...
            $("body")
                ...
                .on(event, function (e) {
                    ...
                    _this.tooltip.container[0].style.left =
                        e.clientX + $(window).scrollLeft() - _this.$map.offset().left + "px";
                    _this.tooltip.container[0].style.top =
                        e.clientY + $(window).scrollTop() - _this.$map.offset().top + "px";
                    ...
                    if (_this.tooltip.mirror.top || _this.tooltip.mirror.bottom) {
                        ...
                        if (_this.tooltip.mirror.top && m.y > _this.tooltip.mirror.top) {
                            ...
                            _this.tooltip.mirror.bottom &&
                            m.y < _this.tooltip.mirror.bottom
                        ) {
                    ...
                    if (
                        _this.tooltip.posShifted.topbottom != _this.tooltip.posOriginal.topbottom ||
                        _this.tooltip.posShifted.leftright != _this.tooltip.posOriginal.leftright
                    ) {
                        _this.tooltip.container[0].className = _this.tooltip.container[0].className.replace(
                            /(^|\s)mapsvg-tt-\S+/g,
                            ""
        ...
        setPopovers: function (options) {
            ...
            _this.$popover.css({
                width:
                    _this.options.popovers.width +
                    (_this.options.popovers.width == "auto" ? "" : "px"),
                "max-width": _this.options.popovers.maxWidth + "%",
                "max-height":
                    (_this.options.popovers.maxHeight * _this.$wrap.outerHeight()) / 100 + "px",
            });
        ...
        setViewBoxOnStart: function () {
            ...
            if (
                (MapSVG.device.ios || MapSVG.device.android) &&
                _this.svgDefault.viewBox[2] > 1500
            ) {
        ...
        setViewBox: function (v, skipAdjustments) {
            ...
            var isZooming =
                parseFloat(d[2]) != _this.viewBox[2] || parseFloat(d[3]) != _this.viewBox[3];
            _this.viewBox = [
                parseFloat(d[0]),
                parseFloat(d[1]),
                parseFloat(d[2]),
            ...
            _this.scroll.tx = Math.round(
                (_this.svgDefault.viewBox[0] - _this.viewBox[0]) * _this.scale
            );
            _this.scroll.ty = Math.round(
                (_this.svgDefault.viewBox[1] - _this.viewBox[1]) * _this.scale
            );
        ...
        setSize: function (width, height, responsive) {
            ...
            if (!_this.options.width && !_this.options.height) {
                ...
                _this.options.width = parseInt(
                    (_this.options.height * _this.svgDefault.width) / _this.svgDefault.height
                );
            } else if (_this.options.width && !_this.options.height) {
                _this.options.height = parseInt(
                    (_this.options.width * _this.svgDefault.height) / _this.svgDefault.width
                );
            }
            ...
            if (_this.markers) _this.markersAdjustPosition();
        ...
        setZoom: function (options) {
            ...
            options = options || {};
            options.on != undefined && (options.on = MapSVG.parseBoolean(options.on));
            options.fingers != undefined &&
                (options.fingers = MapSVG.parseBoolean(options.fingers));
                ...
                if (MapSVG.browser.firefox) {
                    ...
                    $(document).scroll(function () {
                        if (_this.firefoxScroll.insideIframe)
                            window.scrollTo(
                                _this.firefoxScroll.scrollX,
                                _this.firefoxScroll.scrollY
                            );
                    });
                }
        ...
        setControls: function (options) {
            ...
            _this.options.controls.zoomReset = MapSVG.parseBoolean(
                _this.options.controls.zoomReset
            );
            _this.options.controls.userLocation = MapSVG.parseBoolean(
                _this.options.controls.userLocation
            );
        ...
        setZoomButtons: function () {
            ...
            _this.options.zoom.on && loc != "hide"
                ? _this.zoomButtons.show()
                : _this.zoomButtons.hide();
        },
        /**
         * Seems to be unused?
         * @deprecated
        ...
        setCursor: function (type) {
            ...
            if (type == "pointer") _this.$map.addClass("mapsvg-cursor-pointer");
            else _this.$map.removeClass("mapsvg-cursor-pointer");
        },
        /**
        ...
        setGauge: function (options) {
            ...
            if (options.colors) {
                _this.options.gauge.colors.lowRGB = MapSVG.tinycolor(
                    _this.options.gauge.colors.low
                ).toRgb();
                _this.options.gauge.colors.highRGB = MapSVG.tinycolor(
                    _this.options.gauge.colors.high
                ).toRgb();
        ...
        setFilters: function (options) {
            ...
            if (
                [
                    ...
                    "custom",
                    "mapContainer",
                ].indexOf(_this.options.filters.location) === -1
            ) {
                ...
                if (_this.options.filters.location === "custom") {
                    ...
                    if ($("#" + _this.options.filters.containerId).length) {
                        ...
                        console.error(
                            "MapSVG: filter container #" +
                                _this.options.filters.containerId +
                                " does not exists"
                        );
                    }
                } else {
                    if (MapSVG.isPhone) {
                        ...
                        if (
                            _this.options.menu.on &&
                            _this.controllers.directory &&
                            _this.options.menu.location === _this.options.filters.location
                        ) {
                            _this.controllers.directory.view
                                .find(".mapsvg-directory-filter-wrap")
                                .append(_this.$filters);
        ...
        updateFiltersState: function () {
            ...
            if (
                (_this.options.filters && _this.options.filters.on) ||
                ...
                for (var field_name in _this.database.query.filters) {
                    ...
                    if (_this.options.filters.on && filterField) {
                        _this.$filters
                            .find(
                                'select[data-parameter-name="' +
                                    _field_name +
                                    '"],radio[data-parameter-name="\'+_field_name+\'"]'
                            )
                            ...
                            if (!_this.$filterTags) {
                                ...
                                if (_this.$filters) {
                                    ...
                                    if (_this.options.menu.on && _this.controllers.directory) {
                                        _this.controllers.directory.toolbarView.append(
                                            _this.$filterTags
                                        );
                                        _this.controllers.directory.updateTopShift();
                                    } else {
                                        ...
                                        if (_this.options.zoom.buttons.on) {
                                            if (_this.options.layersControl.on) {
                                                if (
                                                    _this.options.layersControl.position ==
                                                    "top-left"
                                                ) {
        ...
        setContainers: function (options) {
            ...
            if (!_this.containersCreated) {
                _this.$wrapAll = $('<div class="mapsvg-wrap-all"></div>')
        ...
        setMenu: function (options) {
            ...
            _this.$directory.toggleClass(
                "flex",
                _this.shouldBeScrollable(_this.options.menu.location)
            );
            ...
            if (_this.options.menu.on) {
                if (!_this.controllers.directory) {
                    _this.controllers.directory = new MapSVG.DirectoryController({
                        ...
                        database:
                            _this.options.menu.source === "regions"
                                ? _this.regionsDatabase
                                : _this.database,
                    ...
                    _this.controllers.directory.database =
                        _this.options.menu.source === "regions"
                            ? _this.regionsDatabase
                            : _this.database;
                    ...
                    _this.controllers.directory.scrollable = _this.shouldBeScrollable(
                        _this.options.menu.location
                    );
                ...
                if (MapSVG.isPhone && _this.options.menu.hideOnMobile) {
                    ...
                    $container =
                        _this.options.menu.location !== "custom"
                            ? _this["$" + _this.options.menu.location]
                            : $("#" + _this.options.menu.containerId);
                }
                ...
                */
                ...
                if (
                    (_this.options.menu.source === "regions" && _this.regionsDatabase.loaded) ||
                    (_this.options.menu.source === "database" && _this.database.loaded)
                ) {
                    if (
                        _this.editMode &&
        ...
        setDatabase: function (options) {
            ...
            if (options.pagination) {
                if (options.pagination.on !== undefined || options.pagination.perpage) {
                    var params = {
                        perpage: _this.options.database.pagination.on
                            ? _this.options.database.pagination.perpage
                            : 0,
                    };
                ...
                if (!MapSVG.googleMapsApiLoaded) {
                    ...
                    if (!_this.googleMaps.map) {
                        ...
                        var southWest = new google.maps.LatLng(
                            _this.geoViewBox.bottomLat,
                            _this.geoViewBox.leftLon
                        );
                        var northEast = new google.maps.LatLng(
                            _this.geoViewBox.topLat,
                            _this.geoViewBox.rightLon
                        );
                        ...
                        if (!_this.options.googleMaps.center || !_this.options.googleMaps.zoom) {
                            ...
                            _this.options.googleMaps.center.lat = parseFloat(
                                _this.options.googleMaps.center.lat
                            );
                            _this.options.googleMaps.center.lng = parseFloat(
                                _this.options.googleMaps.center.lng
                            );
                            ...
                            function () {
                                setTimeout(function () {
                                    ...
                                    setTimeout(function () {
                                        ...
                                        if (
                                            !_this.options.googleMaps.center ||
                                            !_this.options.googleMaps.zoom
                                        ) {
                                            _this.options.googleMaps.center = _this.googleMaps.map
                                                .getCenter()
                                                .toJSON();
                                            _this.options.googleMaps.zoom = _this.googleMaps.map.getZoom();
                                        }
                                        _this.zoomDelta =
                                            _this.options.googleMaps.zoom - _this.zoomLevel;
        ...
        loadGoogleMapsAPI: function (callback, fail) {
            ...
            _this.googleMapsScript.src =
                "https://maps.googleapis.com/maps/api/js?language=en&key=" +
                _this.options.googleMaps.apiKey +
                libraries;
        ...
        loadDetailsView: function (obj) {
            ...
            _this.detailsController = new MapSVG.DetailsController({
                ...
                autoresize:
                    MapSVG.isPhone &&
                    _this.options.detailsView.mobileFullscreen &&
                    _this.options.detailsView.location !== "custom"
                        ? false
                        : _this.options.detailsView.autoresize,
                container: _this.$details,
                template:
                    obj instanceof MapSVG.Region
                        ? _this.templates.detailsViewRegion
                        : _this.templates.detailsView,
                mapsvg: _this,
                ...
                scrollable:
                    (MapSVG.isPhone &&
                        _this.options.detailsView.mobileFullscreen &&
                        _this.options.detailsView.location !== "custom") ||
                    _this.shouldBeScrollable(_this.options.detailsView.location), //['custom','header','footer'].indexOf(_this.options.detailsView.location) === -1,
                withToolbar:
                    !(
                        MapSVG.isPhone &&
                        _this.options.detailsView.mobileFullscreen &&
        ...
        loadFiltersController: function ($container, modal) {
            ...
            var filterDatabase =
                _this.options.filters.source === "regions" ? _this.regionsDatabase : _this.database;
            ...
            var scrollable =
                modal ||
                (!filtersInDirectory &&
                    ["leftSidebar", "rightSidebar"].indexOf(_this.options.filters.location) !== -1);
            ...
            var _filtersController = new MapSVG.FiltersController({
                ...
                events: {
                    shown: function (mapsvg) {
                                ...
                                load: function (_formBuilder) {
                                    ...
                                    if (filtersHide) {
                                        var setFiltersCounter = function () {
                                            var filtersCounter = Object.keys(
                                            ...
                                            if (
                                                filterDatabase.query.filters.search &&
                                                filterDatabase.query.filters.search.length > 0
                                            ) {
                                                filtersCounter--;
                                            }
                                            filtersCounter =
                                                filtersCounter === 0 ? "" : filtersCounter;
                                            _formBuilder &&
                                                _formBuilder.showFiltersButton &&
                                                _formBuilder.showFiltersButton.views.result
                                                    .find("button")
                                                    .html(
                                                        _this.getData().options.filters
                                                            .showButtonText +
                                                            " <b>" +
                                                            filtersCounter +
                                                            "</b>"
                                    ...
                                    if (_this.options.filters.clearButton) {
                                        var clearButton = $(
                                            '<div class="form-group mapsvg-filters-reset-container"><button class="btn btn-default mapsvg-filters-reset">' +
                                                _this.options.filters.clearButtonText +
                                                "</button></div>"
                                        );
                                        _formBuilder.container
                                            .find(".mapsvg-data-form-view")
                                            .append(clearButton);
                                        clearButton.on("click", function () {
                                            _formBuilder.container
                                                .find("input")
                                                .not(
                                                    ":button, :submit, :reset, :hidden, :checkbox, :radio"
                                                )
                                                .val("")
                                                .prop("selected", false);
                                            _formBuilder.container
                        ...
                        formBuilder.view.on(
                            "paste keyup",
                            'input[data-parameter-name="search"]',
                            function () {
                        ...
                        formBuilder.view.on(
                            ...
                            function () {
                                ...
                                if (
                                    $(this).attr("name") === "distanceAddress" ||
                                    field == "search"
                                ) {
                                    return;
                                }
                                if (
                                    $(this).attr("name") === "distanceLatLng" ||
                                    $(this).attr("name") === "distanceLength"
                                ) {
                                    var distanceData = {
                                        units: formBuilder.view
                                            .find('[name="distanceUnits"]')
                                            .val(),
                                        latlng: formBuilder.view
                                            .find('[name="distanceLatLng"]')
                                            .val(),
                                        length: formBuilder.view
                                            .find('[name="distanceLength"]')
                                            .val(),
                                        address: formBuilder.view
                                            .find('[name="distanceAddress"]')
                                            .val(),
                                    };
                                    var field = formBuilder.mapsvg.filtersSchema.schema.find(
                                        function (field) {
        ...
        textSearch: function (elem) {
            ...
            var filterDatabase =
                this.getData().options.filters.source === "regions"
                    ? this.regionsDatabase
                    : this.database;
            filterDatabase.query.setFilters(filter);
     ...
     */
        ...
        checkId: function (id) {
            var _this = this;
            if (_this.getRegion(id)) return { error: "This ID is already being used by a Region" };
        ...
        mayBeFitMarkers: function () {
            ...
            if (
                this.fitDelta > 1000 &&
                !_this.firstDataLoad &&
                !_this.fitOnDataLoadDone &&
                _this.options.fitMarkers
            ) {
                _this.fitMarkers();
            ...
            if (
                _this.firstDataLoad &&
                (_this.options.fitMarkersOnStart ||
                    (_this.options.fitMarkers && _this.options.database.loadOnStart === false))
            ) {
            ...
            if (_this.options.googleMaps.on && typeof google !== "undefined") {
                ...
                if (dbObjects.length > 1) {
                    ...
                    if (
                        ...
                        dbObjects[0].location.lat &&
                        dbObjects[0].location.lng
                    ) {
                        var coords = {
                            lat: dbObjects[0].location.lat,
                            lng: dbObjects[0].location.lng,
                        };
                        if (_this.googleMaps.map) {
        ...
        updateSize: function () {
            ...
            if (_this.directoryWrap) _this.directoryWrap.height(_this.$wrap.outerHeight());
        },
        /**
        ...
        zoomIn: function (center) {
            ...
            if (_this.googleMaps.map) {
                if (!_this.isZooming) {
                    var currentZoomInRange =
                        _this.zoomLevel >= _this.options.zoom.limit[0] &&
                        _this.zoomLevel <= _this.options.zoom.limit[1];
                    ...
                    var newZoomInInRange =
                        svg_zoom_new >= _this.options.zoom.limit[0] &&
                        svg_zoom_new <= _this.options.zoom.limit[1];
        ...
        zoomOut: function (center) {
            ...
            if (_this.googleMaps.map) {
                if (
                    !_this.isZooming &&
                    _this.googleMaps.map.getZoom() - 1 >= _this.options.googleMaps.minZoom
                ) {
                    var currentZoomInRange =
                        _this.zoomLevel >= _this.options.zoom.limit[0] &&
                        _this.zoomLevel <= _this.options.zoom.limit[1];
        ...
        zoomTo: function (mapObjects, zoomToLevel) {
            ...
            if (
                mapObjects instanceof MapSVG.Marker ||
                mapObjects instanceof MapSVG.MarkersCluster
            ) {
            ...
            if (typeof mapObjects == "object" && mapObjects.length !== undefined) {
                ...
                if (mapObjects[0] instanceof MapSVG.Region) {
                    ...
                    mapObjects[0] instanceof MapSVG.Marker ||
                    mapObjects[0] instanceof MapSVG.MarkersCluster
                ) {
                    var xs = [];
                    var ys = [];
                    ...
                    var padding = 10;
                    padding =
                        _this.convertPixelToSVG([padding, 0])[0] -
                        _this.convertPixelToSVG([0, 0])[0];
        ...
        zoomToMarkerOrCluster: function (mapObject, zoomToLevel) {
            ...
            _this.setViewBox([mapObject.x - vb[2] / 2, mapObject.y - vb[3] / 2, vb[2], vb[3]]);
            _this._scale = _this.zoomLevels[_this.zoomLevel]._scale;
            return;
        },
        /**
        ...
        zoom: function (delta, center, exact) {
            ...
            if (!exact) {
                ...
                if (!_this.zoomLevels[_this.zoomLevel + d]) return;
                ...
                if (
                    isInZoomRange &&
                    (_this._zoomLevel > _this.options.zoom.limit[1] ||
                        _this._zoomLevel < _this.options.zoom.limit[0])
                )
                    return false;
            ...
            if (center) {
                ...
                shift = [
                    (center[0] - _this.viewBox[0]) * koef,
                    (center[1] - _this.viewBox[1]) * koef,
                ];
            ...
            if (_this.options.scroll.limit) {
                if (newViewBox[0] < _this.svgDefault.viewBox[0])
                    ...
                    _this.svgDefault.viewBox[0] + _this.svgDefault.viewBox[2]
                )
                    newViewBox[0] =
                        _this.svgDefault.viewBox[0] + _this.svgDefault.viewBox[2] - newViewBox[2];

                if (newViewBox[1] < _this.svgDefault.viewBox[1])
                    newViewBox[1] = _this.svgDefault.viewBox[1];
                else if (
                    newViewBox[1] + newViewBox[3] >
                    _this.svgDefault.viewBox[1] + _this.svgDefault.viewBox[3]
                )
                    newViewBox[1] =
                        _this.svgDefault.viewBox[1] + _this.svgDefault.viewBox[3] - newViewBox[3];
            }
        ...
        markerDelete: function (marker) {
            ...
            if (_this.markers.length == 0) _this.options.markerLastID = 0;
        },
        /**
        ...
        markerId: function () {
            ...
            if (_this.getMarker(id)) return _this.markerId();
            else return id;
        },
        /**
        ...
        labelsRegionsAdjustPosition: function () {
            ...
            _this.regions.forEach(function (region) {
                ...
                if (region.textLabel)
                    region.textLabel[0].style.transform =
                        "translate(-50%,-50%) translate(" + pos[0] + "px," + pos[1] + "px)";
            });
        },
        /**
        ...
        scrollMove: function (e) {
            ...
            if (_this.options.scroll.limit) {
                if (vx < _this.svgDefault.viewBox[0]) vx = _this.svgDefault.viewBox[0];
                else if (
                    _this.viewBox[2] + vx >
                    _this.svgDefault.viewBox[0] + _this.svgDefault.viewBox[2]
                )
                    vx =
                        _this.svgDefault.viewBox[0] +
                        _this.svgDefault.viewBox[2] -
                        _this.viewBox[2];

                if (vy < _this.svgDefault.viewBox[1]) vy = _this.svgDefault.viewBox[1];
                else if (
                    _this.viewBox[3] + vy >
                    _this.svgDefault.viewBox[1] + _this.svgDefault.viewBox[3]
                )
                    vy =
                        _this.svgDefault.viewBox[1] +
                        _this.svgDefault.viewBox[3] -
                        _this.viewBox[3];
            }
        ...
        scrollEnd: function (e, mapsvg, noClick) {
            ...
            if (
                noClick !== true &&
                Math.abs(_this.scroll.dx) < 5 &&
                Math.abs(_this.scroll.dy) < 5
            ) {
                // _this.popoverOffHandler(e);
                if (_this.editMarkers.on) _this.clickAddsMarker && _this.markerAddClickHandler(e);
                else if (_this.region_clicked) _this.regionClickHandler(e, _this.region_clicked);
            }
        ...
        panBy: function (x, y) {
            ...
            if (_this.options.scroll.limit) {
                ...
                if (
                    (svg.left - x > bounds.left && x < 0) ||
                    (svg.right - x < bounds.right && x > 0)
                ) {
                    tx = _this.scroll.tx;
                    scrolled.x = false;
                }
                if (
                    (svg.top - y > bounds.top && y < 0) ||
                    (svg.bottom - y < bounds.bottom && y > 0)
                ) {
                    ty = _this.scroll.ty;
                    scrolled.y = false;
                }
        ...
        selectRegion: function (id, skipDirectorySelection) {
            ...
            if (
                _this.options.actions.region.click.addIdToUrl &&
                !_this.options.actions.region.click.showAnotherMap
            ) {
        ...
        deselectRegion: function (region) {
            ...
            if (!region) region = _this.getRegion(_this.selected_id[0]);
            if (region) {
                region.deselect();
        ...
        selectMarker: function (marker) {
            ...
            if (!(marker instanceof MapSVG.Marker)) return false;
        ...
        convertSVGToPixel: function (xy) {
            ...
            if (_this.options.googleMaps.on) {
                if (_this.viewBox[0] - _this.svgDefault.viewBox[0] > _this.svgDefault.viewBox[2]) {
                    ...
                    shiftX =
                        worldMapWidth *
                        Math.floor(
                            (_this.viewBox[0] - _this.svgDefault.viewBox[0]) /
                                _this.svgDefault.viewBox[2]
                        );
                }
            }
            ...
            return [
                (xy[0] - _this.svgDefault.viewBox[0] + shiftX) * scale,
                (xy[1] - _this.svgDefault.viewBox[1] + shiftY) * scale,
            ];
        },
        /**
        ...
        convertPixelToSVG: function (xy) {
            ...
            var scale = _this.getScale();
            return [
                xy[0] / scale + _this.svgDefault.viewBox[0],
                xy[1] / scale + _this.svgDefault.viewBox[1],
            ];
        },
        /**
        ...
        convertGeoToSVG: function (coords) {
            ...
            var x =
                (lon - _this.geoViewBox.leftLon) *
                (_this.svgDefault.viewBox[2] / _this.mapLonDelta);

            var lat = (lat * 3.14159) / 180;
            // var worldMapWidth = ((_this.svgDefault.width / _this.mapLonDelta) * 360) / (2 * 3.14159);
            var worldMapWidth =
                ((_this.svgDefault.viewBox[2] / _this.mapLonDelta) * 360) / (2 * 3.14159);
            var mapOffsetY =
                (worldMapWidth / 2) *
                Math.log(
                    (1 + Math.sin(_this.mapLatBottomDegree)) /
                        (1 - Math.sin(_this.mapLatBottomDegree))
                );
            var y =
                _this.svgDefault.viewBox[3] -
        ...
        convertSVGToGeo: function (tx, ty) {
            ...
            var worldMapRadius =
                ((_this.svgDefault.viewBox[2] / _this.mapLonDelta) * 360) / (2 * Math.PI);
            var mapOffsetY =
                (worldMapRadius / 2) *
                Math.log(
                    (1 + Math.sin(_this.mapLatBottomDegree)) /
            ...
            var lon =
                _this.geoViewBox.leftLon + (tx / _this.svgDefault.viewBox[2]) * _this.mapLonDelta;
        ...
        pickGaugeColor: function (gaugeValue) {
            ...
            var rgb = [
                Math.round(
                    _this.options.gauge.colors.diffRGB.r * w + _this.options.gauge.colors.lowRGB.r
                ),
                Math.round(
                    _this.options.gauge.colors.diffRGB.g * w + _this.options.gauge.colors.lowRGB.g
                ),
                Math.round(
                    _this.options.gauge.colors.diffRGB.b * w + _this.options.gauge.colors.lowRGB.b
                ),
                Math.round(
                    _this.options.gauge.colors.diffRGB.a * w + _this.options.gauge.colors.lowRGB.a
                ),
            ];
            return rgb;
        },
        ...
        isRegionDisabled: function (id, svgfill) {
            ...
            if (
                _this.options.regions[id] &&
                (_this.options.regions[id].disabled || svgfill == "none")
            ) {
                return true;
            } else if (
                (_this.options.regions[id] == undefined ||
                    MapSVG.parseBoolean(_this.options.regions[id].disabled)) &&
        ...
        regionClickHandler: function (e, region) {
            ...
            if (_this.eventsPreventList["click"]) return;
            ...
            if (region.isRegion()) {
                ...
                if (actions.region.click.showAnotherMap) {
                    ...
                    if (linkParts.length > 1) {
                        ...
                        if (map_id) {
                            var container = actions.region.click.showAnotherMapContainerId
                                ? $("#" + actions.region.click.showAnotherMapContainerId)
                                : _this.$map;
                            jQuery.get(
                                ajaxurl,
                                { action: "mapsvg_get", id: map_id },
                                function (data) {
                                    // var prevoptions = $.extend({}, container.mapSvg().getData().options);
                                    if (container.find("svg").length) container.mapSvg().destroy();
                ...
                if (actions.marker.click.showDetails) _this.loadDetailsView(passingObject);
        ...
        popoverAdjustPosition: function () {
            ...
            _this.$popover[0].style.transform =
        ...
        showPopover: function (object) {
            ...
            var mapObject =
                object instanceof MapSVG.Region
                    ? object
                    : object.location && object.location.marker && object.location.marker
            ...
            _this.popover = new MapSVG.PopoverController({
                ...
                template:
                    object instanceof MapSVG.Region
                        ? _this.templates.popoverRegion
                        : _this.templates.popoverMarker,
                mapsvg: _this,
                data: object instanceof MapSVG.Region ? object.forTemplate() : object,
                mapObject: mapObject,
                scrollable: true,
                withToolbar:
                    MapSVG.isPhone && _this.options.popovers.mobileFullscreen ? false : true,
                events: {
                    shown: function (mapsvg) {
                        if (_this.options.popovers.centerOn) {
                            var shift = this.container.height() / 2;
                            if (
                                _this.options.popovers.centerOn &&
                                !(MapSVG.isPhone && _this.options.popovers.mobileFullscreen)
                            ) {
                                _this.centerOn(mapObject, shift);
                            }
                        }
                        try {
                            _this.events["shown.popover"] &&
                                _this.events["shown.popover"].call(this, _this);
                        } catch (err) {
                            console.log(err);
                        }
                    ...
                    closed: function (mapsvg) {
                        ...
                        //}
                        try {
                            _this.events["closed.popover"] &&
                                _this.events["closed.popover"].call(this, mapsvg);
                        } catch (err) {
                            console.log(err);
                        }
        ...
        mouseOutHandler: function (e, object) {
            ...
            if (_this.options.tooltips.on) _this.hideTip();
            if (object instanceof MapSVG.Region) {
                ...
                if (!_this.editMarkers.on) {
                    ...
                    _this.$map.on(
                        ...
                        function (e) {
                            ...
                            if (
                                _this.touchScrollStart === undefined ||
                                _this.touchScrollStart === $(window).scrollTop()
                            ) {
        ...
        setLabelsMarkers: function (options) {
            ...
            if (_this.options.labelsMarkers.on) {
                _this.markers.forEach(function (marker) {
                    if (!marker.textLabel) {
                        marker.textLabel = jQuery(
                            '<div class="mapsvg-marker-label" data-object-id="' +
                                marker.object.id +
                                '"/>'
                        );
        ...
        reloadRegions: function () {
            ...
            _this.$svg.find("path, polygon, circle, ellipse, rect").each(function (index) {
                ...
                if ($(this)[0].getAttribute("id")) {
                    if (
                        !_this.options.regionPrefix ||
                        (_this.options.regionPrefix &&
                            $(this)[0].getAttribute("id").indexOf(_this.options.regionPrefix) === 0)
                    ) {
                        var region = new MapSVG.Region(
                            $(this),
                            _this.options,
                            _this.regionID,
                            _this
        ...
        reloadRegionsFull: function () {
            ...
            _this.regions.forEach(function (region) {
                ...
                if (r) {
                    ...
                    if (
                        _this.options.filters.filteredRegionsStatus !== null &&
                        _this.options.filters.filteredRegionsStatus !== "" &&
                        _this.options.filters.filteredRegionsStatus !== undefined
                    ) {
                ...
                setTimeout(function () {
                    ...
                    if (_this.markers.length > 1) {
                        _this.markers.forEach(function (m) {
                            if (
                                m.node.offset().left <
                                _this.$map.offset().left + _this.$map.width() / 2
                            ) {
                                markers.left++;
                            } else {
                                markers.right++;
        ...
        updateOutdatedOptions: function (options) {
            ...
            if (
                options.detailsView &&
                (options.detailsView.location === "near" || options.detailsView.location === "top")
            ) {
            ...
            if (!options.controls) {
                ...
                options.controls.zoom =
                    options.zoom && options.zoom.on && options.zoom.buttons.location !== "hide";
                options.controls.location =
                    options.zoom && options.zoom.buttons.location !== "hide"
        ...
        init: function (opts, elem) {
            ...
            else opts.source = opts.source.replace(/^.*:\/\/[^\/]+/, "").replace("//", "/");
            ...
            if (_this.events.beforeLoad)
                try {
                    _this.events.beforeLoad.call(_this);
                } catch (err) {}

            if (
                _this.events.beforeLoad &&
                _this.events.beforeLoad["beforeLoad"] &&
                typeof _this.events.beforeLoad["beforeLoad"] === "function"
            ) {
                try {
            ...
            _this.$map
                ...
                .css("background", _this.options.colors.background);
            ...
            _this.$loading = $("<div>" + _this.options.loadingText + "</div>").addClass(
                "mapsvg-loading"
            );
            ...
            $.ajax({ url: _this.options.source + "?v=" + _this.options.svgFileVersion })
                .fail(function (resp) {
                    if (resp.status == 404) {
                        var msg =
                ...
                .done(function (xmlData) {
                    ...
                    if (_this.svgDefault.width && _this.svgDefault.height) {
                        _this.svgDefault.width = parseFloat(
                            _this.svgDefault.width.replace(/px/g, "")
                        );
                        _this.svgDefault.height = parseFloat(
                            _this.svgDefault.height.replace(/px/g, "")
                        );
                        _this.svgDefault.viewBox = _this.svgDefault.viewBox
                            ? _this.svgDefault.viewBox.split(" ")
                            : [0, 0, _this.svgDefault.width, _this.svgDefault.height];
                    ...
                    if (geo) {
                        ...
                        if (geo.length == 4) {
                            ...
                            _this.mapLonDelta =
                                _this.geoViewBox.rightLon - _this.geoViewBox.leftLon;
                    ...
                    _this._viewBox =
                        (_this.options.viewBox.length == 4 && _this.options.viewBox) ||
                        _this.svgDefault.viewBox;
                    ...
                    if (_this.options.popover) _this.options.popovers = _this.options.popover;
                    _this.setPopovers(_this.options.popovers);

                    if (_this.options.cursor) _this.setCursor(_this.options.cursor);

                    _this.setTemplates(_this.options.templates);

                    // Load extension (frontend things)
                    if (
                        !_this.options.backend &&
                        _this.options.extension &&
                        $().mapSvg.extensions &&
                        $().mapSvg.extensions[_this.options.extension]
                    ) {
                    ...
                    _this.database = new MapSVG.DatabaseService(
                        {
                            ...
                            perpage: _this.options.database.pagination.on
                                ...
                                : 0,
                            sortBy:
                                _this.options.menu.source == "database"
                                    ? _this.options.menu.sortBy
                                    : "id",
                            sortDir:
                                _this.options.menu.source == "database"
                                    ? _this.options.menu.sortDirection
                                    : "desc",
                            table: "database",
                        },
                        _this
                    ...
                    _this.database.on("dataLoaded", function () {
                        ...
                        try {
                            _this.events["databaseLoaded"] &&
                                _this.events["databaseLoaded"].call(_this);
                        } catch (err) {
                            console.log(err);
                        }
                    ...
                    _this.regionsDatabase.on("dataLoaded", function () {
                        ...
                        if (_this.events["regionsLoaded"]) {
                            if (
                                _this.events["regionsLoaded"].length &&
                                _this.events["regionsLoaded"].length > 0
                            ) {
        ...
        final: function () {
            ...
            if (_this.options.dataLoaded) _this.options.dataLoaded.call();

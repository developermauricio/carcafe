(function ($, window) {
    ...
    MapSVGAdminDrawController.prototype.setEventHandlers = function () {
        ...
        switch (this.mode) {
            ...
            case "edit":
                ...
                _this.mapsvg
                    .getData()
                    .$map.on("mouseover.draw.mapsvg", ".mapsvg-region", function () {
                ...
                _this.mapsvg
                    .getData()
                    .$map.on("mouseout.draw.mapsvg", ".mapsvg-region", function () {
                        // if(_this.isDragging || (_this.editingShape && _this.editingShape.obj === this))
                        //     return;
                ...
                _this.mapsvg
                    .getData()
                    .$map.on("mouseup.draw.mapsvg", ".mapsvg-image-background", function (e) {
                        e.originalEvent.preventDefault();
    ...
    MapSVGAdminDrawController.prototype.dragPointMove = function (e) {
        ...
        var d = {
            x: xy[0] - _this.dragStartMouseCoords[0],
            y: xy[1] - _this.dragStartMouseCoords[1],
        };
    ...
    MapSVGAdminDrawController.prototype.moveLastPathPoint = function (e) {
        ...
        _this.editingShape.obj.setAttribute(
            ...
            _this.editingShape.d +
                "L" +
                _this.editingShape.lastPoint[0] +
                " " +
                _this.editingShape.lastPoint[1] +
                " "
        );
    };
    ...
    MapSVGAdminDrawController.prototype.addPointToPath = function (xy) {
        ...
        _this.editingShape.obj.setAttribute(
            "d",
            _this.editingShape.d + "L" + xy[0] + " " + xy[1] + " "
        );
        _this.editingShape.d = _this.editingShape.obj.getAttribute("d");
    ...
    MapSVGAdminDrawController.prototype.saveSvg = function () {
        ...
        $.get(_this.filepath + "?v=" + Math.random()).done(function (xmlData) {
            ...
            var filename = _this.filepath.split("/").pop();
            var fileData = newSVG[0].outerHTML.replace(/\sgeoViewBox/gi, " mapsvg:geoViewBox");
            fileData = '<?xml version="1.0" encoding="UTF-8" standalone="no"?>\n' + fileData;
            var blob = new Blob([fileData], { type: "text/xml" });
            formData.append("file", blob, filename);
            formData.append("path", _this.filepath);
            formData.append("action", "mapsvg_save_svg");
            formData.append("_wpnonce", MapSVG.nonce);
            formData.append("map_id", _this.mapsvg.id);
